...
class _AuthCardState extends State<AuthCard> with SingleTickerProviderStateMixin{
  ...
  void initState() {
    ...
    _position = Tween<Offset>(begin: Offset(0,-1.5),end: Offset(0,0)).animate(CurvedAnimation(parent: _controller!, curve: Curves.easeIn));
  ...
  Future<void> _submit() async{
    ...
    try {
      ...
      showErrorDialogue(message);
        ...
        print(error);
        const message = 'Could not authenticate you. please try later.';
        showErrorDialogue(message);
    }
